...
urlpatterns = [
    ...
    path('login_as_admin', LoginView.as_view(template_name='ecom/v2/login/admin_login.html'), name='login_as_admin'),
    ...
    path('register_as_customer', customer_register_view),
