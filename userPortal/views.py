...
def admin_view_booking_view(request):
    ...
    for order in orders:
        ...
        ordered_products.append(ordered_product)
        ordered_bys.append(ordered_by)
    return render(request,'ecom/v2/admin/admin_view_booking.html',{'data':zip(ordered_products,ordered_bys,orders)})
...
def search_view(request):
    ...
    return render(request,'ecom/v2/home/index.html',{'products':products,'word':word,'product_count_in_cart':product_count_in_cart})
...
def cart_view(request):
    ...
    return render(request,'ecom/v2/cart/cart.html',{'products':products,'total':total,'product_count_in_cart':product_count_in_cart})
...
def customer_home_view(request):
    ...
    return render(request,'ecom/v2/home/customer_home.html',{'products':products,'product_count_in_cart':product_count_in_cart})
...
def customer_address_view(request):
    ...
    return render(request,'ecom/v2/cart/customer_address.html',{'addressForm':addressForm,'product_in_cart':product_in_cart,'product_count_in_cart':product_count_in_cart})
